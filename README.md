...
1- Run `voms-proxy-init --rfc --voms cms -valid 192:00` and `cmsenv`

2- Run `python3 submit_crab_l1tt.py customise_L1TrackNtupleMaker.py <sample> -n 10 -d outdir -a tag`
